...
var add_creature, add_money, buy_creature, callbacks, check_for_new_game, clear_creatures, currAttack, currentFight, currentQuestion, data, data_, e, fight_attack, fight_attack_tooltip, fight_change_vals, fight_check_question, fight_enemy_attack, fight_parse_inline_vars, fight_question, fight_start, get_JSON, init, isInArray, load_attacks, load_creatures, load_questions, load_story, money, notify, open_shop, owned_creatures, parse_inline_vars, parse_story, parse_story_element, play_sound, pop, random, reset, reset_test, set_active_creature, set_character, set_name, set_storyline, shop_dialog, show_choose_creature, skip_tut, update_money, update_shop;
