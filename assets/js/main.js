...
fight_attack_tooltip = function(self, other, dat, i) {
  var result;
  result = "";
  if (other && parseFloat(dat.other_val) !== 0 && parseFloat(dat.other_val) > 0 && dat.other_type.toLowerCase() !== 'attack' && dat.other_type.toLowerCase() !== 'defense') {
  ...
  } else if (other && parseFloat(dat.other_val) !== 0 && parseFloat(dat.other_val) < 0 && dat.other_type.toLowerCase() !== 'attack' && dat.other_type.toLowerCase() !== 'defense') {
    result += '<p><b>Enemy: </b>' + dat.other_type.toUpperCase() + ' ' + Math.round(dat.other_val * currentFight.player_attack_multiplier * currentFight.enemy_defense_multiplier * currentFight.player_lvl / 33) + '</p>';
  } else if (other && parseFloat(dat.other_val) !== 0 && parseFloat(dat.other_val) > 0 && dat.other_type.toLowerCase() === 'attack' && dat.other_type.toLowerCase() !== 'defense') {
  ...
  if (self && parseFloat(dat.self_val) !== 0 && parseFloat(dat.self_val) > 0 && dat.self_type.toLowerCase() !== 'attack' && dat.self_type.toLowerCase() !== 'defense') {
  ...
  } else if (self && parseFloat(dat.self_val) !== 0 && parseFloat(dat.self_val) < 0 && dat.self_type.toLowerCase() !== 'attack' && dat.self_type.toLowerCase() !== 'defense') {
    result += '<p><b>You: </b>' + dat.self_type.toUpperCase() + ' ' + Math.round(dat.self_val * currentFight.player_attack_multiplier * currentFight.enemy_defense_multiplier * currentFight.player_lvl / 33) + '</p>';
  } else if (self && parseFloat(dat.self_val) !== 0 && parseFloat(dat.self_val) > 0 && dat.self_type.toLowerCase() === 'attack' && dat.self_type.toLowerCase() !== 'defense') {
